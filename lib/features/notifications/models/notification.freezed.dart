...
class _$AppNotificationImpl implements _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, userId: $userId, type: $type, title: $title, message: $message, data: $data, isRead: $isRead, priority: $priority, actionUrl: $actionUrl, expiresAt: $expiresAt, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
